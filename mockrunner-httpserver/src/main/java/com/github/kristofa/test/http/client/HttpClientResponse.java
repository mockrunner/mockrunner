...
/**
 * Http Response as being returned by a {@link HttpClient}. Provides the user
 * with the HTTP response code, response entity and optional error message.
 * <p>
 * IMPORTANT: Call {@link HttpClientResponse#close()} method when done with
 * process response. This will clean-up resources.
 * 
 * @author kristof
 * @param <T>
...
public interface HttpClientResponse<T> {
	...
	/**
	 * Indicates if result of http request was successful. Response was
	 * successful in case there is no error message.
	 * 
	 * @return <code>true</code> in case request was successful, false in case
	 *         request failed.
	 */
	boolean success();
	 ...
	 * 
	 * @return the error message. Will be <code>null</code> in case request was
	 *         successful.
	 */
