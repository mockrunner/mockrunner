...
public class HttpRequestImpl implements HttpRequest {
	...
	private transient String clientPort;
	...
	/**
	 * Copy constructor. Will initialize http request with content of given
	 * request.
	 * 
	 * @param request
	 *            Request to copy.
	...
	public void addAllHttpMessageHeaders(final Set<HttpMessageHeader> httpMessageHeaders) {
	...
	/**
	 * Sets {@link ContentMatcher}. It will be initialized with any existing
	 * data.
	 * 
	 * If not set a default {@link ContentMatcher} will be used which simply
	 * does an equals on byte array.
	 * 
	 * @param matcher
	 *            New Content matcher. Should not be <code>null</code>.
	 * @return This http request.
	 * @throws UnexpectedContentException
	 *             In case the current content is incompatible with the new
	 *             ContentMatcher. In this case the new matcher will not be set.
	 *             The previous {@link ContentMatcher} will remain active.
	 */
	 ...
	 * 
	 * @param key
	 *            Parameter key. Should not be empty or <code>null</code> or
	 *            blank.
	 * @param value
	 *            Parameter value. Should not be empty or <code>null</code> or
	 *            blank.
	 * @return This http request.
	 */
	 ...
	 * 
	 * @param name
	 *            header name. Should not be <code>null</code> or blank.
	 * @param value
	 *            header value. Should not be <code>null</code> or blank.
	 * @return This http request.
	 */
	 ...
	 * 
	 * @param name
	 *            Http message header name.
	 * @param value
	 *            Http message header value.
	 * @return This http request.
	 */
