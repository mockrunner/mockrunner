 ...
 * <li>contentType: Content type of the message body. Content of Content-Type
 * header.</li>
...
public final class FullHttpRequestImpl implements FullHttpRequest {
	 ...
	 * 
	 * @param request
	 *            Will copy properties from this request.
	 */
	 ...
	 * 
	 * @param key
	 *            Parameter key. Should not be empty or <code>null</code>.
	 * @param value
	 *            Parameter value. Should not be empty or <code>null</code>
	 * @return This http request.
	 */
	...
	public String getUrl() {
		try {
			...
			final URI uri = new URI("http", host, httpRequest.getPath(),
					queryParamsAsString.isEmpty() ? null : queryParamsAsString, null);
	...
	public void setClientPort(String clientPort) {
		httpRequest.setClientPort(clientPort);
	}
	...
	public String getClientPort() {
		return httpRequest.getClientPort();
	}
