...
/**
 * Mock Http Server which can be used to return upfront defined responses for a
 * set of http requests.
 *
 * Mock http server will in its default configuration return code 598 in case it
 * receives a request which was not foreseen. In case of an internal exception
 * it will return http returncode 599.
 * 
 * @author kristof
 */
public class MockHttpServer {
	 ...
	 * 
	 * @param port
	 *            Port on which mock server should operate. If you provide 0 as
	 *            port number a free port will be choosen for you. You can get
	 *            the port through {@link MockHttpServer#getPort()}
	 * @param responseProvider
	 *            {@link HttpResponseProvider}. Should not be <code>null</code>.
	 */
	 ...
	 * 
	 * @return The port in case the server is successfully started or -1 in case
	 ...
	 *             In case we got unexpected requests or we did not get all
	...
	/**
	 * Allows you to set a custom response code to be returned when no matching
	 * response is found.
	 *
	 * If not set the default code is 598.
	 * 
	 * @param code
	 *            HTTP response code to return when no matching response is
	 *            found.
	 */
	...
	/**
	 * Allows to set a custom response code to be returned when an unexpected
	 * exception happens.
	 *
	 * If not set the default code is 599.
	 * 
	 * @param code
	 *            HTTP response code to return when an unexpected exception
	 *            happens.
	 */
