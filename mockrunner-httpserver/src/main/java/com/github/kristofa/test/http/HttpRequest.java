...
/**
 * Contains the HTTP request properties required to identify or compare a HTTP
 * request.
 * 
 * @author kristof
 */
public interface HttpRequest {
	 ...
	 * 
	 * @param key
	 *            Query parameter key. Should not be <code>null</code> or blank.
	 ...
	 * 
	 * @param name
	 *            Name/key. Should not be <code>null</code> or blank.
